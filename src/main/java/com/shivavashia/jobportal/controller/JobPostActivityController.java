...
import com.shivavashia.jobportal.services.JobPostActivityService;
import com.shivavashia.jobportal.services.JobSeekerApplyService;
import com.shivavashia.jobportal.services.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    @GetMapping("/dashboard_Recruiter/")
    public String searchJobs_Recruiter(Model model){
        RecruiterProfile currentUserProfile= (RecruiterProfile) userService.getCurrentUserProfile();
        Authentication authentication=SecurityContextHolder.getContext().getAuthentication();

        if(!(authentication instanceof AnonymousAuthenticationToken)){
            String username=authentication.getName();
            model.addAttribute("username",username);
            System.out.println("craxyyyyy"+username);
            List<RecruiterJobsDTO> jobsDTOS=jobPostActivityService.getRecruiterJobs(currentUserProfile.getUser_account_id());
            model.addAttribute("jobPost",jobsDTOS);
        }
        System.out.println("Current User Profile Class: " + currentUserProfile.getClass().getName());
        System.out.println("Current User Profile Object: " + currentUserProfile.toString());
        model.addAttribute("user", currentUserProfile);

        return "dashboard";
    }

    @GetMapping("/dashboard_JobSeeker/")
    public String searchJobs_JobSeeker(Model model, @RequestParam(value = "job",required = false) String job,
        ...
        JobSeekerProfile currentUserProfile= (JobSeekerProfile) userService.getCurrentUserProfile();
        Authentication authentication=SecurityContextHolder.getContext().getAuthentication();
